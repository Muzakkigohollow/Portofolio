...
const About = lazy(() => import("./components/About")) as any;
const Skills = lazy(() => import("./components/Skills")) as any;
const Experience = lazy(() => import("./components/Experience")) as any;
const Projects = lazy(() => import("./components/Projects")) as any;
        ...
        >
          <Suspense fallback={<div className="w-full h-full bg-[#050505]" />}>
            <About
              ...
              onSlideChange={(index: number, dir: number) => {
