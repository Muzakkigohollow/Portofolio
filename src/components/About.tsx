...
// ─── SLIDE MAP ───
const slides = [Slide1, Slide2, Slide5];
...
// ─── ABOUT COMPONENT ───
const slideLabels = ["The Developer", "Background", "The Code"];
    ...
    <div className="relative w-full h-full bg-[#050505] font-sans overflow-hidden">
      ...
      <AnimatePresence initial={true} custom={direction}>
        {isActive && (
          ...
          >
            <ActiveSlide onActionTriggered={slideIndex === 2 ? onSlide5Action : undefined} />
          </motion.div>
        )}
      </AnimatePresence>
