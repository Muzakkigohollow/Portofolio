                ...
                <div className="flex w-full h-full text-zinc-500/40 font-mono text-[8px] md:text-xs pt-24 md:pt-16 uppercase">
                    <div className="w-48 md:w-64 border-r border-white/5 p-6 pt-4 hidden sm:block bg-black/40">
                        ...
                        <div className="flex flex-col gap-3 lowercase">
                            <div className="flex items-center gap-2"><span className="text-[8px] uppercase">▼</span> MUZAKKI-OS</div>
            ...
            >
                ...
                >
                    <div className="flex flex-col md:flex-row gap-6 md:gap-12 text-zinc-500 font-mono text-[9px] md:text-[10px] tracking-[0.3em] md:tracking-[0.5em] uppercase">
                        <a href="mailto:muzakki28fadlil@gmail.com" target="_blank" rel="noopener noreferrer" className="relative overflow-hidden group">
                            <span className="inline-block transition-transform duration-500 group-hover:-translate-y-full">Email</span>
                            <span className="absolute inset-0 text-[#c9a84c] transition-transform duration-500 translate-y-full group-hover:translate-y-0">Email</span>
                        </a>
                        <a href="https://github.com/Muzakkigohollow" target="_blank" rel="noopener noreferrer" className="relative overflow-hidden group">
                        ...
                        <a href="https://instagram.com/wozkki28_" target="_blank" rel="noopener noreferrer" className="relative overflow-hidden group">
                            <span className="inline-block transition-transform duration-500 group-hover:-translate-y-full">Instagram</span>
                            <span className="absolute inset-0 text-[#c9a84c] transition-transform duration-500 translate-y-full group-hover:translate-y-0">Instagram</span>
                        </a>
                    </div>
                </motion.div>
            </motion.div>
